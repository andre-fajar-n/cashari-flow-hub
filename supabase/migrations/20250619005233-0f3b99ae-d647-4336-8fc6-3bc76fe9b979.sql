...
CREATE TABLE public.transfers (
  ...
  from_currency VARCHAR(10) REFERENCES public.currencies(code) NOT NULL,
  to_currency VARCHAR(10) REFERENCES public.currencies(code) NOT NULL,
  date DATE NOT NULL,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE public.goal_transfers (
  ...
  from_currency VARCHAR(10) REFERENCES public.currencies(code),
  to_currency VARCHAR(10) REFERENCES public.currencies(code),
